...
namespace petsolutionlogin.Data
{
    public class DataAccess
    {
        ...
        public DataAccess()
        {
            ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\RIFANANJIBA\Documents\PetData.mdf;Integrated Security=True;Connect Timeout=30"; ;
        }
